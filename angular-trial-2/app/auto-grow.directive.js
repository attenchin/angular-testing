    ...
    return {
        ...
        execute: function() {
            AutoGrowDirective = (function () {
                ...
                AutoGrowDirective.prototype.contructor = function (ag, renderer) {
                };
                AutoGrowDirective.prototype.onFocus = function () {
                    this.renderer.setElementStyle(this.ag.nativeElement, 'width', '200');
                };
                AutoGrowDirective.prototype.onBlur = function () {
                    this.renderer.setElementStyle(this.ag.nativeElement, 'width', '120););
                };
